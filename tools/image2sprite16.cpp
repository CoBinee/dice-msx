// g++ -o image2sprite16 `sdl2-config --cflags --libs` -lSDL2_image image2sprite16.cpp
...
static int ConvertImage(SDL_Surface *image, const char *filename, const char *label)
{
    ...
    // ファイルへの出力
    {
        ...
        // ヘッダの出力
        fprintf(outfile, "; image2sprite16\n;\n\n");
